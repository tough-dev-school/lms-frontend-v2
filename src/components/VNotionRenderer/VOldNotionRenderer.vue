...
<template>
  <NotionRenderer class="NotionRenderer_Old" v-bind="rendererProps" prism />
</template>
...
<style lang="scss">
  ...
  width: 100%;
    ...
    .notion-to-do-item > input:checked {
      border: 2px solid var(--select-color-0);
      background-color: var(--select-color-0);
