...
<template>
  <label class="w-full">
    ...
    <input
      :type="type"
      v-bind="$attrs"
      class="leading-1.5 block h-module w-full rounded-8 border border-gray bg-offwhite p-module px-16 text-black placeholder:text-gray focus:border-blue focus:outline-none dark:bg-darkmode-white"
      :class="{
        'border-red': error,
      }"
      data-testid="input"
