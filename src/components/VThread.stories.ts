...
import { getCommentData, getThreadData } from '@/mocks/homework';
...
originalPost.descendants = [
  getCommentData(originalPost),
  getCommentData(originalPost),
  getCommentData(originalPost),
];
originalPost.descendants[1].descendants = [getCommentData(originalPost)];
